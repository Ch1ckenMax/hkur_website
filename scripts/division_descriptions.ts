...
async function divisionDescriptionChange(divId: string): Promise<void>{
    //Text change
    ...
    leftText.innerHTML = divisionDescription[divId as keyof typeof divisionDescription][0] as string;
    rightText.innerHTML = divisionDescription[divId as keyof typeof divisionDescription][1] as string;
